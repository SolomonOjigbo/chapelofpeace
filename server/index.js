...
const boardOfTrusteesRoute = require("./routes/boardOfTrustees.route");
...
const childrenStoriesRoute = require("./routes/childrenStories.route");
const eventsRoute = require("./routes/events.route");
const liveStreamingRoute = require("./routes/liveStreaming.route");
// const fileUploadRoute = require("./routes/fileUpload.route");
const { port, origin } = require("./config");
const dbRoute = require("./routes/db.route");

let newOrigin = [origin, "https://res.cloudinary.com", "*"];
...
app.use("/api", liveStreamingRoute);
